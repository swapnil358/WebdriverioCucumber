...
#############################################################
# @AuthorName : Samanantha rhods
# @TestID : jira.getinsured.com/HIX-14455, jira.getinsured.com/HIX-11111,
# @Description : verify user dashboard.
#############################################################

 Scenario: Verify User dashboard
    Given I am on the Amazon login page
    When I enter a valid email and password
       | username | password |
       | Admin    | admin123 |
